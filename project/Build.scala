...
object MinimalBuild extends Build {
  ...
  lazy val root = Project(id = "akka-quickser-serialization", base = file("."), settings = Project.defaultSettings).settings(
    ...
    crossPaths := false,
    libraryDependencies += "com.romix" % "quickser" % "1.0-SNAPSHOT",
